...
const HeroSectionHomePage = () => {
  ...
  <div className=" mx-auto flex  md:flex-row flex-col items-center ">
            <div className="md:w-[60%] xl:w-[50%] py-10  lg:py-10 h-screen flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center px-2 md:px-10 xl:px-24 bg-white/20 transition-all duration-500 backdrop-blur-sm ">
              ...
              <p className="mb-8 leading-relaxed">Ofrecemos fondos de inversión con mejores rendimientos y las comisiones más competitivas del mercado para democratizar la inversión, mientras tu dinero trabaja para ti. Deja el trabajo duro a los expertos.</p>
      <div className="flex justify-center">
        ...
        <div className="mb-3 flex items-center gap-x-3 pr-10 ">
                ...
                <Image src={SMVLogo} alt='smvlogo' height={1000} width={1000} className='w-1/2' />
        </div>
    </div>
