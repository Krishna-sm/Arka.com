...
const Footer = () => {
  return (
      ...
      <footer className='py-10 bg-[#F6F6FC]  px-3  md:px-10 lg:px-24 flex flex-col lg:flex-row  items-center gap-y-10 gap-x-10 md:items-start w-full  justify-between'>
        ...
        <div className="  w-full mx-auto transition-all duration-300 md:w-1/2 lg:w-[30%] xl:w-[20%] flex justify-start flex-col   items-center gap-y-2 lg:items-start px-4">
          ...
          <div className="">
            ...
            <div className="mb-2">
              <Image src={SMVLogo} alt='smv-logo' width={1000} height={1000} className='w-[40%] mx-auto lg:w-full' />
            </div>
          </div>
        </div>
      </footer>
